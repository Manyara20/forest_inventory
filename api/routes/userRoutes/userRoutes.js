...
import { getConservancy, getCounty, getSpecies, getStation, retrievepermissions } from '../../controllers/dropdownController.js';
...
import { deleteManagement, editManagement, management_insert, searchManagement } from '../../controllers/plantationmgtControllers/managementController.js';
import {  deleteworkflow, editWorkflow, searchWorkflow, workflow_insert } from '../../controllers/workflow/workflowController.js';
...
router.delete('/deletemanagement/:id', deleteManagement)
//////
//workflow routes
router.post('/workflows', workflow_insert)
router.get('/workflows', searchWorkflow)
router.patch('/workflows/:id', editWorkflow)
