...
const ConfirmPassword = (props) => {
  ...
  const {placeholder, label, maximLength, name, ifRequired, errors, register, watchValue}=props;
    ...
    <div className='my-2'>
        <label className={`${styles.formLabels}`}>{label}</label>
            <div className='relative'>
                <input className={customPasswordClass} id="passsword" type={showPassword? 'text': 'password'} placeholder={placeholder} 
                {...register(name, { required: {value: ifRequired, message: "Password is Required"},
                        ...
                        validate: (value) => value === watchValue || "The passwords do not match" })} />
